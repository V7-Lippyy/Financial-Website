...
<head>
    ...
    <link rel="shortcut icon" href="https://i.ibb.co/4ZGNLvj/Finan-4.pngg">
    <title>FinanSiap - Tambah Data</title>
    ...
    <style>
        body {
            background-image: url('https://img.freepik.com/premium-vector/background-abstract-4_24725-151.jpg?w=1380');
...
<body>
    <div class="header">
        <img src="https://i.ibb.co/4ZGNLvj/Finan-4.pngg" width="25px" height="25px" class="float-left logo-fav">
        <h3 class="text-secondary font-weight-bold float-left logo">FinanSiap</h3>
        <a href="logout">
            <div class="logout">
    ...
    <div class="sidebar">
        <nav>
            <ul>
                <li>
                    <img src="https://i.ibb.co/L5tRVgc/Finan-5.png" class="img-fluid profile float-left" width="60px">
