...
<head>
    ...
    <title>FinansialKu - Pengeluaran</title>
    ...
    <style>
        body {
            background-image: url('https://i.ibb.co.com/Ky9CxxP/Game-Night-6.gif');
        ...
        .input-group .form-control.cari {
            border-right: 0;
        }

        .input-group .input-group-text.icone {
            background-color: white;
            border-left: 0;
        }
    </style>
...
<body>
    ...
    <div class="main-content khusus">
        <div class="konten khusus2">
            <div class="konten_dalem khusus3 white-box">
